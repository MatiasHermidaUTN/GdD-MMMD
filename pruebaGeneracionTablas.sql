...
CREATE TABLE [MMMD].[Agente] (
	[AGENTE_CODIGO] numeric(19, 0) NOT NULL PRIMARY KEY,
...
BEGIN
	...
	SELECT DISTINCT
		m.MONEDA_NOMBRE
	FROM gd_esquema.Maestra m
	WHERE m.MONEDA_NOMBRE IS NOT NULL
END
GO
...
BEGIN
	...
	WHERE m.AGENTE_APELLIDO IS NOT NULL
END
GO
...
BEGIN 
	...
	SELECT DISTINCT 
		m.ALQUILER_CODIGO,
		m.DETALLE_ALQUILER_NRO_PERIODO_INI, 
		m.DETALLE_ALQUILER_NRO_PERIODO_FIN, 
...
BEGIN
	...
	JOIN MMMD.ALQUILER_ESTADO e ON e.ESTADO_ALQUILER_NOMBRE = m.ALQUILER_ESTADO 
	WHERE ALQUILER_CODIGO IS NOT NULL
END
GO
